...
int main(int argc, char** argv)
{
  ...
  LOG_FATAL_IF(!is_ok) << "read verilog file " << verilog_file_path << " failed.";
  ...
  // parse liberty file
  Liberty lib_parser;
  std::string lib_file_path = curr_path + "/../testcase/lib/skywater130/sky130_fd_sc_hd__tt_025C_1v80.lib";
